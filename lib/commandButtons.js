...
const COMMAND_BUTTONS = {
    ...
    repo: {
        buttons: [
            { type: 'url', text: '⭐ Star Repo', url: 'https://github.com/sil3nt-wolf/silentwolf/stargazers' },
            { type: 'url', text: '🍴 Fork Repo', url: 'https://github.com/sil3nt-wolf/silentwolf/fork' },
