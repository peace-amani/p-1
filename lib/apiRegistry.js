...
export const API_REGISTRY = {
    ...
    gpt:          { label: 'ChatGPT',               category: 'ai',          paramStyle: 'keyword', testQuery: 'hello',                             url: 'https://apis.xwolf.space/api/ai/gpt',      fallbackUrl: 'https://apis-e3qq.onrender.com/api/ai/gpt' },
    gemini:       { label: 'Gemini AI',             category: 'ai',          paramStyle: 'keyword', testQuery: 'hello',                             url: 'https://apis.xwolf.space/api/ai/gemini',   fallbackUrl: 'https://apis-e3qq.onrender.com/api/ai/gemini' },
    claude:       { label: 'Claude AI',             category: 'ai',          paramStyle: 'keyword', testQuery: 'hello',                             url: 'https://apis.xwolf.space/api/ai/claude',   fallbackUrl: 'https://apis-e3qq.onrender.com/api/ai/claude' },
    deepseek:     { label: 'DeepSeek AI',           category: 'ai',          paramStyle: 'keyword', testQuery: 'hello',                             url: 'https://apis.xwolf.space/api/ai/deepseek', fallbackUrl: 'https://apis-e3qq.onrender.com/api/ai/deepseek' },
    mistral:      { label: 'Mistral AI',            category: 'ai',          paramStyle: 'keyword', testQuery: 'hello',                             url: 'https://apis.xwolf.space/api/ai/mistral',  fallbackUrl: 'https://apis-e3qq.onrender.com/api/ai/mistral' },
    groq:         { label: 'Groq AI',               category: 'ai',          paramStyle: 'keyword', testQuery: 'hello',                             url: 'https://apis.xwolf.space/api/ai/groq',     fallbackUrl: 'https://apis-e3qq.onrender.com/api/ai/groq' },
